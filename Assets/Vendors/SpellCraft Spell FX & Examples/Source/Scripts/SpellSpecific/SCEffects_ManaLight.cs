 ...
 **/
public class SCEffects_ManaLight : MonoBehaviour {

	[Header("Prefabs")]
	public GameObject lineRendererPrefab;
	public GameObject lightRendererPrefab;
	public GameObject glowParticlesPrefab;
	...
	private int numberOfBounces = 1;
	private float timeBetweenBounces = 0.2f;
